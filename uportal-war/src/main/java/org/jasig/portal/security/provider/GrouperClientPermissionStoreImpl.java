...
/**
 * IPermissionStore back by the GrouperClient.
 * @author William G. Thompson, Jr.
 * @version $Revision$
 */
@Repository
public class GrouperClientPermissionStoreImpl implements IPermissionStore {

    private static final Log log = LogFactory.getLog(GrouperClientPermissionStoreImpl.class);
            ...
            throws AuthorizationException
    {
        ...
        System.out.println("RDBMPermissionImpl.select(): [" + query + "] for owner=[" + owner + "] and principal=["
                + principal + "] and activity=[" + activity + "] and target=[" + target + "] and type=[" + type + "] returned permissions [" + perms + "]");

        if ("UP_ERROR_CHAN".equals(owner)) {

            //String permDef = "apps:portal:permissions:UP_ERROR_CHAN:errorChanPermDef";
            ...
            GcGetPermissionAssignments gcGetPermissionAssignments = new GcGetPermissionAssignments().assignPermissionType("role").addAction(action);
